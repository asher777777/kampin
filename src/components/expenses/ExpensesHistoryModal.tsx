...
export function ExpensesHistoryModal({ isOpen, onClose, expenses }: ExpensesHistoryModalProps) {
      ...
      >
        ...
        >
          ...
          <div className="bg-black p-6 border-b border-amber-500/20 shadow-sm relative z-10 flex items-center justify-between">
            <h2 className="text-xl font-black text-amber-500 tracking-wide">היסטוריית הוצאות</h2>
            <button
              onClick={onClose}
