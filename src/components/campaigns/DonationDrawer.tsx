      ...
      <div className={`max-w-lg w-full p-5 sm:p-6 shadow-2xl relative my-auto rounded-t-3xl sm:rounded-3xl border transition-colors ${
        ...
        {step === "payment" && (
          <div className="space-y-4 animate-in fade-in duration-300">
            ...
            {isTestMode && (
              <div className="p-3 bg-amber-500/20 border border-amber-500/70 rounded-2xl flex items-center gap-2.5 text-xs text-amber-200 shadow-md">
                ...
                <div className="text-right">
                  ...
                  <span className="text-[11px] text-amber-100/90 leading-tight">
                    לא תבוצע פנייה לשרתי האשראי של קשר. התרומה תאושר מיידית ותירשם במסד הנתונים כ'משולם'.
                  </span>
                </div>
              </div>
            )}
